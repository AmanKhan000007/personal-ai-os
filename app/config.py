...
AUTO_BACKUP_ENABLED=os.getenv("AUTO_BACKUP_ENABLED","true").strip().lower() in ("1","true","yes","on")
AUTO_BACKUP_HOUR=int(os.getenv("AUTO_BACKUP_HOUR","3"))
AUTO_BACKUP_KEEP=int(os.getenv("AUTO_BACKUP_KEEP","14"))
