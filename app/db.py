...
CREATE TABLE IF NOT EXISTS memories (
 id INTEGER PRIMARY KEY AUTOINCREMENT, owner_id TEXT NOT NULL, content TEXT NOT NULL,
 category TEXT NOT NULL DEFAULT 'general', importance REAL NOT NULL DEFAULT 0.5,
 confidence REAL NOT NULL DEFAULT 1.0, source TEXT NOT NULL DEFAULT 'chat',
...
CREATE TABLE IF NOT EXISTS documents (
 ...
 extracted_text TEXT NOT NULL DEFAULT '', created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
);
